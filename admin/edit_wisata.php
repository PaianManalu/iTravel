...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        $query_select = "SELECT `id`, `nama`, `garis_lintang`, `garis_bujur`, `alamat`, `icon`, `gambar` FROM `tb_wisata` WHERE `id` = $id";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query_update = "UPDATE `tb_wisata` SET `nama` = '$nama', `garis_lintang` = '$garis_lintang', `garis_bujur` = '$garis_bujur', `alamat` = '$alamat', `icon` = '$icon', `gambar` = '$gambar' WHERE `id` = $id";
