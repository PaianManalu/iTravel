...
$id_ = input($_GET['id']);
$query = mysqli_query($kon, "SELECT * FROM tb_map WHERE id='" . $id_ . "' LIMIT 1");
...
<body>
    ...
    <h1>
        <?php echo !empty($data['nama']) ? $data['nama'] : "Data tidak ditemukan"; ?>
    </h1>

    <div class="head">
        <div class="gambar">
            <img src="<?php echo !empty($data['gambar']) ? $data['gambar'] : "Data tidak ditemukan"; ?>"
                alt="<?php echo !empty($data['nama']) ? $data['nama'] : "Data tidak ditemukan"; ?>"
                class="gambar-wisata">
        </div>
        <div class="info">
            <h3>Informasi</h3>
            <p>
                ...
                <?php echo !empty($data['alamat']) ? $data['alamat'] : "Data tidak ditemukan"; ?>
            </p>
            <p>
                <strong>Garis_lintang :</strong>
                <?php echo !empty($data['garis_lintang']) ? $data['garis_lintang'] : "Data tidak ditemukan"; ?>
            </p>
            <p>
                <strong>Garis Bujur :</strong>
                <?php echo !empty($data['garis_bujur']) ? $data['garis_bujur'] : "Data tidak ditemukan"; ?>
            </p>
        </div>
        <div class="text">
            <p>
                <?php echo !empty($data['deskripsi']) ? $data['deskripsi'] : "Data tidak ditemukan"; ?>
            </p>
        </div>
    </div>
