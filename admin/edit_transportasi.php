...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        $query_select = "SELECT `id`, `nama`, `garis_lintang`, `garis_bujur`, `alamat`, `icon`, `gambar` FROM `tb_transportasi` WHERE `id` = $id";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query_update = "UPDATE `tb_transportasi` SET `nama` = '$nama', `garis_lintang` = '$garis_lintang', `garis_bujur` = '$garis_bujur', `alamat` = '$alamat', `icon` = '$icon', `gambar` = '$gambar' WHERE `id` = $id";
    ...
    <a href="tb_transportasi.php" class="back-button">Kembali ke Halaman Utama</a>
</body>
